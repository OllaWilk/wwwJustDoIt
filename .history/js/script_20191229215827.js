...
const personalDataLink = document.getElementById('personalData');

const generalPage = document.querySelector('.generalStatistics')

generalLink.addEventListener('click', function() {
    generalPage.classList.toggle('active');
});

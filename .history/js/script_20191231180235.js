...

{
    ...
    quitPage.addEventListener('click', function() {
        const links = document.querySelectorAll('titles i');
    ...
    const titleClickHandler = function(event) {
        ...
        const activeArticlesPages = document.querySelectorAll('.post_page');
        for (let activeArticlesPage of activeArticlesPages) {
            activeArticlesPage.classList.remowe('active');
        };

        //get 'href' attribute from the clicked link

        const articleSelector = clickedElement.getAttribute('href');
        console.log("działa? " + articleSelector);

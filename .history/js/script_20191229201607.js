...
const opts = {
    generalStatisticPage : '.generalStatistics',
    linksPage : '.links',
    personalDataTablePage : '.personalDataTable',
...
const generalStatisticLink = document.getElementById('general');
const generalStatisticPage = document.querySelector('.generalStatistics');

generalStatisticLink.addEventListener('click', function(){
    generalStatisticPage.classList.toggle('active');
});
